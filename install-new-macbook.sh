...
CLIPROXY_MODEL="${CLIPROXY_MODEL:-gpt-5.6-terra}"
...
OPENCLAW_FIX_STEP_TIMEOUT_SECONDS="${OPENCLAW_FIX_STEP_TIMEOUT_SECONDS:-600}"
...
CLIPROXY_STEP_TIMEOUT_SECONDS="${CLIPROXY_STEP_TIMEOUT_SECONDS:-300}"
